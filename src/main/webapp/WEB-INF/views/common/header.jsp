...
<body>
	...
	<form id="EasyloginFrm" name="EasyloginFrm"
		...
		<input type="radio" id="NonMember" name="radio-group" value="NonMember">
		<label for="option1">NonMember</label><br>
  ...
  <div id="container">
        ...
        <div class="loginContainer">
          <form id="loginFrm" name="loginFrm" action="" method="post">
            <table>
              <tr>
                <td>
                  <input type="text" name="memberId" id="memberId" placeholder="아이디" tabindex="1" value="">
                </td>
                <td rowspan="2"><input type="submit" value="로그인"></td>
                <td rowspan="2"><input type="button" value="회원가입" onclick=""></td>
              </tr>
              <tr>
	...
	<% } else if (easyLoginMember.equals("Reporter")) { %>
	  <div class="bannerContainerUpper" role="banner">기자메뉴</div>
      <div class="bannerContainerLower">
      	<br>
        <h1>기자화면</h1>
      </div>
