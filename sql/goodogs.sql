...
insert into news_script values(seq_news_script_no.NEXTVAL,'kdc0526@naver.com','하이라이트확인해보자','경제','<div>이 기상과 이 맘으로 충성을 다하여 괴로우나 즐거우나</div> <div>나라 사랑하세</div> <div>무궁화 삼천리 화려강산 대한사람 대한으로</div> 길이 보전하세 <div>이 기상과 이 맘으로 충성을 다하여 괴로우나 즐거우나</div> <div>나라 사랑하세</div> <div>무궁화 삼천리 화려강산 대한사람 대한으로</div> 길이 보전하세 ',to_date('20210903','yyyymmdd'),'경제',2);   
...
insert into news_image values(19,'제목없음.png','20230718_8.png',default);
